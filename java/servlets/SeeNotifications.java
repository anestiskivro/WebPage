...
/**
 * Servlet implementation class SeeNotifications
 */
public class SeeNotifications extends HttpServlet {
	 ...
	 */
	//o kwdikas edw einai gia show active borrowings
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			JsonArray ja = g.notifications(s.getUser_id());
